...
import (
	...
	"github.com/barrett370/kit/v2/metrics"
	"github.com/barrett370/kit/v2/metrics/prometheus"
)
...
For more information, see [the package documentation](https://godoc.org/github.com/barrett370/kit/v2/metrics).
